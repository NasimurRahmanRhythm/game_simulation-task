export default teams = {
    ...
    NewZeLands: ["Devon Conway", "Will Young", "Rachin Ravindra", "Daryl Mitchell", "Tom Latham (c & wk)", "Glenn Phillips", "Mark Chapman", "Mitchell Santner", "Matt Henry", "Lockie Ferguson", "Trent Boult"],
